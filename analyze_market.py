...
api_key = "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"  # Your OpenRouter API key
base_url = "https://openrouter.ai/api/v1"

# NewsAPI Key (شما باید API Key خود را از NewsAPI بگیرید)
news_api_key = "91297ee8d0e547869a966441772e4e22"  # Your NewsAPI key
